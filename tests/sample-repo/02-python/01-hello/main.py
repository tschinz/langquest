...
#
# Your first Python functions! In this exercise you will implement four
# small functions covering greetings, string formatting, conditional logic,
# and arithmetic.
#
# TODO: Implement each function below. Replace `pass` with your solution.
#       Do NOT modify the tests at the bottom of this file.
